...
This is a **publishable skills repository** for AI coding agents, following the [skills.sh](https://skills.sh) standard. It contains a curated collection of development guidelines, best practices, and domain knowledge that can be consumed by AI assistants like Open Code, VS Code, Claude Code, etc.
...
# Local clone
git clone https://github.com/Fyvel/agent-skills.git
...
{
  "skills": {
    "sources": ["./path/to/agent-skills/.agent-skills"]
  }
}
```
